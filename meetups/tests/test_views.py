...
class TestBoardingPassView:
    ...
    @pytest.mark.asyncio
    async def test_check_boarding_pass(self, async_client: AsyncClient, transaction: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_check_boarding_pass_validation(self, async_client: AsyncClient, transaction: AsyncSession):
...
class TestBoardingPassGetImage:
    @pytest.mark.asyncio
    async def test_get_image(self, flush_test_database, async_client: AsyncClient,
    ...
    @pytest.mark.asyncio
    async def test_boarding_pass_not_exists(self, flush_test_database, async_client: AsyncClient,
                                            transaction: AsyncSession):
...
class TestCreateBoardingPass:
    ...
    @pytest.mark.asyncio
    async def test_create_boarding_pass(self, flush_test_database, async_client: AsyncClient,
                                        transaction: AsyncSession):
